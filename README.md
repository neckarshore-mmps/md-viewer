...
1. **Two design themes** — **Minimalist** (black/white/grey, system fonts) and
   **Swiss Grid** (IBM Plex, red accent, decorative left index rail, loud
   theme-scoped header/footer — the default). Pick via the nav **dropdown**
