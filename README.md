...
top of the identical split view. The **Open .md** dialog uses the File System
Access API where available (Chrome/Edge): it defaults to the **Downloads** folder
and remembers the **last-used folder** across sessions; it falls back to a plain
file input in Firefox/Safari. Deployed to Vercel:
